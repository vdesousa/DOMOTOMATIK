...
$req = $bdd->prepare('UPDATE capteur SET etat = :nvetat WHERE id_capteur=3');
$req->execute(array('nvetat' => $etat));

$req->closeCursor();
// Redirection du visiteur vers la page du capteur
header('Location: capteurl.php');
}
...
$req = $bdd->prepare('UPDATE parametrer SET valeur_souhaitee = :nvvaleur WHERE id_capteur = 3');
...
$req = $bdd->prepare('UPDATE parametrer SET heure_debut = :nvhoraire_debut, heure_fin = :nvhoraire_fin WHERE id_capteur = 3');
$req->execute(array(
